...
DEBIAN_FRONTEND=noninteractive apt-get install -y \
                                       ...
                                       libfreetype-dev libxslt1-dev libzip-dev libonig-dev \
                                       libsodium-dev libgmp-dev libicu74 pkg-config ruby ruby-dev sudo wget curl zip unzip jq rsync >/dev/null 2>&1
# ====================================================================================
...
/raweb/apps/php84/bin/php -r "copy('https://getcomposer.org/installer', 'composer-setup.php');"
ACTUAL_SIGNATURE="$(/raweb/apps/php84/bin/php -r "echo hash_file('sha384', 'composer-setup.php');")"
if [ "$EXPECTED_SIGNATURE" != "$ACTUAL_SIGNATURE" ]; then
    >&2 echo 'ERROR: Invalid installer signature'
    rm composer-setup.php
    exit 1
fi
/raweb/apps/php84/bin/php composer-setup.php --install-dir="$DEB_ROOT/raweb/apps/php84/bin" --filename=composer
RESULT=$?
rm composer-setup.php
if [ $RESULT -ne 0 ]; then
...
Depends: libxml2, libssl-dev, libbz2-1.0, libjpeg8, libicu74, libcurl4-openssl-dev, libpng-dev, libwebp7, libfreetype6, libxslt1.1, libzip-dev, libonig5, libsodium23, libgmp10, default-libmysqlclient-dev, zlib1g, libsqlite3-0
EOF
# ====================================================================================
