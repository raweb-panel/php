...
Depends: libxml2, libssl-dev, libbz2-1.0, libjpeg8, libcurl4-openssl-dev, libpng-dev, libwebp7, libfreetype6, libxslt1.1, libzip-dev, libonig5, libsodium23, libgmp10, libicu-dev, default-libmysqlclient-dev, zlib1g, libsqlite3-0
EOF
